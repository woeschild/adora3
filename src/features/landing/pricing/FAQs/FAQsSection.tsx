...
export default function FAQsSection() {
  ...
  const faqItems = [
    ...
    },
    {
      ...
      answer: "Absolutely! Adora Call is designed to be flexible and customizable, allowing you to tailor features and functionalities to align with your unique business processes and requirements."
    },
    {
