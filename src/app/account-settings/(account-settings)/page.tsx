  ...
  return (
    <div className="flex flex-col space-y-2">
      ...
      <div className="relative">
        <input
          type="text"
          className="w-full rounded-md border border-gray-300 p-2 focus:border-orange-500 focus:ring focus:ring-orange-500 focus:ring-opacity-50"
          placeholder={label}
        />
        {type === 'select' && (
  ...
  return (
    <div className="p-6 space-y-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="flex flex-col space-y-2">
            <div className="flex items-center">
              ...
              <span className="ml-2 px-2 py-1 bg-orange-800 text-orange-200 text-xs rounded-full font-medium">12 days left</span>
            </div>
      ...
      <div className="bg-white p-6 rounded-lg shadow-md border border-gray-200 space-y-6">
        <h3 className="text-lg font-semibold text-gray-800">Fill in the AI Agent Information</h3>
